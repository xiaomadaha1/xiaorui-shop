export function Lhead2() {
  var oSpan = document
    .getElementById("lyh-nav-head2")
...
export function Lr_tt() {
  var oSpan = document
    .getElementById("lyh-cnt0_r_tt")
    .getElementsByTagName("span");
  for (var i = 0; i < 3; i++) {
    oSpan[i].onmouseover = function () {
      for (var j = 0; j < 3; j++) {
...
export function L1Ft() {
  var oSpan = document
    .getElementById("lyh-content1_1Ft")
    .getElementsByTagName("span");
...
export function L2Ft() {
  var oSpan = document
    .getElementById("lyh-content1_1Ft2")
    .getElementsByTagName("span");
  var oDiv4 = document.getElementById("lyh-content1_1Fb_R4");
  var oDiv5 = document.getElementById("lyh-content1_1Fb_R5");
  var oDiv6 = document.getElementById("lyh-content1_1Fb_R6");
...
export function L3Ft() {
  var oSpan = document
    .getElementById("lyh-content1_1Ft3")
    .getElementsByTagName("span");
  var oDiv7 = document.getElementById("lyh-content1_1Fb_R7");
  var oDiv8 = document.getElementById("lyh-content1_1Fb_R8");
  var oDiv9 = document.getElementById("lyh-content1_1Fb_R9");
